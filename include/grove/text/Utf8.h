...
//   Il a été REMONTÉ de modules/BgfxRenderer/Text/ vers include/grove/text/ pour que les
//   consommateurs hors renderer (la mesure de texte de l'UI, cf. TextMetrics.h) le partagent
//   au lieu d'en dupliquer une variante — deux décodeurs UTF-8 = deux vérités qui divergent.
//   L'ancien chemin reste valide (en-tête de redirection), donc aucun appelant ne bouge.
...
// QUOI : cet octet est-il une CONTINUATION UTF-8 (10xxxxxx) — donc pas une frontière de caractère ?
// POURQUOI : se déplacer/supprimer par caractère (et non par octet) demande de savoir reconnaître
//   le milieu d'un codepoint. Sans ça, un Backspace sur "é" en coupe la moitié et corrompt la chaîne.
// COMMENT : masque des deux bits de tête. Les octets de tête (0xxxxxxx, 110xxxxx, 1110xxxx, 11110xxx)
//   ne matchent pas — eux seuls sont des frontières valides.
